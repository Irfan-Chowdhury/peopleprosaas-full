            ...
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            @if(isset($user->profile_photo))
                                <img src="{{asset('landlord/images/profile/'.$user->profile_photo)}}" height="120" width="120">
                            @else
                            ...
                            <form method="POST" action="{{ route('admin.profile_update', $user->id)}}" enctype="multipart/form-data" method="POST">
                                @csrf
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="italic"><small>{{__('The field labels marked with * are required input fields')}}.</small></p>
                            <form method="POST" action="{{ route('admin.password_update',$user->id)}}" >
                                @csrf
