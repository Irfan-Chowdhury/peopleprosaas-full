...
class ProjectDiscussionController extends Controller
{
    ...
    public function store(Request $request, Project $project)
    {
        ...
        $data['discussion_attachment'] = Utility::fileUploadHandle($request->discussion_attachments, tenantPath().'/uploads/project_discussion_attachments', 'discussion');
    ...
    public function destroy($id)
    {
        ...
        $directory = tenantPath().'/uploads/project_discussion_attachments/';
        Utility::fileDelete($directory, $project->discussion_attachment);
    ...
    public function download($id)
    {
        ...
        $download_path = public_path(tenantPath().'/uploads/project_discussion_attachments/'.$file_path);
