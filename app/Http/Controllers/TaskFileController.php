...
class TaskFileController extends Controller
{
    ...
    public function store(Request $request, Task $task)
    {
        ...
        $data['file_attachment'] = Utility::fileUploadHandle($request->file_attachment, tenantPath().'/uploads/task_file_attachments', 'task_file');
    ...
    public function destroy($id)
    {
        ...
        $directory = tenantPath().'/uploads/task_file_attachments/';
    ...
    public function download($id)
    {
        ...
        $download_path = public_path(tenantPath().'/uploads/task_file_attachments/'.$file_path);
