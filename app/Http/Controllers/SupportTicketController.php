...
class SupportTicketController extends Controller
{
    ...
    public function store(Request $request)
    {
        if (auth()->user()->can('store-ticket') || auth()->user()) {
            $validator = Validator::make($request->only('subject', 'company_id', 'department_id', 'employee_id', 'ticket_priority', 'description', 'ticket_note', 'ticket_attachments'),
                [
                    'subject' => 'required',
                    'company_id' => 'required',
            ...
            $data['ticket_attachment'] = Utility::fileUploadHandle($request->ticket_attachments, tenantPath().'/uploads/ticket_attachments', 'ticket');
    ...
    public function destroy($id)
    {
        ...
        if ($logged_user->can('delete-ticket')) {
            $ticket = SupportTicket::findOrFail($id);
            $directory = tenantPath().'/uploads/ticket_attachments/';
            Utility::fileDelete($directory, $ticket->ticket_attachment);
            $ticket->delete();
    ...
    public function download($id)
    {
        ...
        $download_path = public_path(tenantPath().'/uploads/ticket_attachments/'.$file_path);
