...
class OfficialDocumentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($logged_user->can('store-official_document')) {
            ...
            $data['document_file'] = Utility::fileUploadHandle($request->document_file, tenantPath().'/uploads/official_documents', $request->document_title);
        ...
        if ($logged_user->can('edit-official_document')) {
            ...
            if (isset($file)) {
                ...
                if ($file->isValid()) {
                    ...
                    $file->move(public_path(tenantPath().'/uploads/official_documents'), $file_name);
    ...
    public function delete_by_selection(Request $request)
    {
        ...
        if ($logged_user->can('delete-official_document')) {
            ...
            foreach ($files as $file) {
                ...
                if ($file_path) {
                    $file_path = public_path(tenantPath().'/uploads/official_documents/'.$file_path);
    ...
    public function download($id)
    {
        ...
        $file_path = $file->document_file;
        $download_path = public_path(tenantPath().'/uploads/official_documents/'.$file_path);
