...
class FileManagerController extends Controller
{
        ...
        if ($logged_user->can('store-file_manager')) {
            ...
            if (isset($file)) {
                if ($file->isValid()) {
                    ...
                    $file->move(public_path(tenantPath().'/uploads/file_manager'), $file_name_extension);
                }
            }
    ...
    public function update(Request $request)
    {
        ...
        if ($logged_user->can('edit-file_manager')) {
            ...
            if ($file_path) {
                $file_path_old = public_path(tenantPath().'/uploads/file_manager/'.$file_path.'.'.$file_extension);
                $file_path_new = public_path(tenantPath().'/uploads/file_manager/'.$file_name.'.'.$file_extension);
    ...
    public function destroy($id)
    {
        ...
        if ($logged_user->can('delete-file_manager')) {
            ...
            if ($file_path) {
                $file_path = public_path(tenantPath().'/uploads/file_manager/'.$file_path.'.'.$file_extension);
    ...
    public function download($id)
    {
        ...
        $file_path = $file->file_name;
        $file_extension = $file->file_extension;
        $download_path = public_path(tenantPath().'/uploads/file_manager/'.$file_path.'.'.$file_extension);
