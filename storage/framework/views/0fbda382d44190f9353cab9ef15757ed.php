    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel"> <?php echo app('translator')->get('file.Edit Feature'); ?> </h5>
...
<?php /**PATH /var/www/peopleprosaas/resources/views/landlord/super-admin/pages/features/edit-modal.blade.php ENDPATH**/ ?>