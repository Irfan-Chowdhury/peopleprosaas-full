...
<div id="loader"></div>
    ...
    <?php echo $__env->make('landlord.super-admin.partials.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <?php echo $__env->make('landlord.super-admin.partials.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>


 <section id="content" class="page animate-bottom d-none">
    <?php echo $__env->yieldContent('landlord-content'); ?>

    <?php echo $__env->make('landlord.super-admin.partials.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</section>
