            ...
            <div class="d-flex flex-row">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('store-user')): ?>
                        <div class="dropdown mr-1">
                            ...
                            <button <?php if(isset($isAllowToCreateUser) && !$isAllowToCreateUser): ?> disabled title="Disabled | Limit Exceeded" <?php endif; ?> class="btn btn-info dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/peopleprosaas/resources/views/all_user/index.blade.php ENDPATH**/ ?>