        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 offset-md-3 text-center mt-3 mb-5">
                    <a href="<?php echo e(url('blog')); ?>" class="button style1"><?php echo e(__('file.All Blogs')); ?></a>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('landlord.public-section.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/peopleprosaas/resources/views/landlord/public-section/pages/landing_page/index.blade.php ENDPATH**/ ?>